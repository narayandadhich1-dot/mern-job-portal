        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className="flex items-center gap-2 mt-4">
              ...
              <Badge className={"text-[#7209BA] font-bold"} variant="ghost">{singleJob?.salary} LPA</Badge>
            </div>
          </div>
          <Button
          ...
          onClick={isApplied?null: applyJobHandler}
            ...
            disabled={isApplied}
            className={`rounded-lg text-white ${isApplied ? "bg-gray-600 cursor-not-allowed" : "bg-[#7209BA] hover:bg-[#5f089e] cursor-pointer"}`}
          >
